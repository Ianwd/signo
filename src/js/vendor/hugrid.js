 ...
 window.hugrid = {
  ...
  makehugrid = function () {
    ...
    if (rowheight !== 0)  {
      ...
      pageheight     = height;//pageheight     = $(document.body).height();
    ...
    $('#hugridButton').append('<span id="hugbuttonON">Grid On</span>');
    $('#hugridButton').append('<span id="hugbuttonOFF" style="display:none;">Grid Off</span>');
...
$(document).ready(function() {/* GRID BASED ON 1040 WIDTH FOR 1440 VIEWPORT*/
  pageUnits = 'px';
  colUnits = 'px';
  // pagewidth = 72.2222222222;
  pagewidth = 1040;
  columns = 8;
  // columnwidth = 9.0277777778;
  columnwidth = 130;
  gutterwidth = 0;
  pagetopmargin = 0;
  rowheight = 0; /*8*/
